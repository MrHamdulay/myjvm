...
RuntimeInvisibleAnnotations = namedtuple('RuntimeVisibleAnnotations', 'type_index annotations')
...
RuntimeVisibleAnnotations = namedtuple('RuntimeVisibleAnnotations', 'type_index annotations')
